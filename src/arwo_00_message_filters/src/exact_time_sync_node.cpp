...
public:
  ...
  : Node("approx_time_sync_node")
  {
    ...
    camera_info_sync_->registerCallback(
      std::bind(
        &ExactTimeSyncNode::sensor_callback, this, _1,
        _2));
  }
...
private:
  typedef message_filters::TimeSynchronizer<sensor_msgs::msg::Image,
      sensor_msgs::msg::CameraInfo> CameraInfoSynchronizer;
